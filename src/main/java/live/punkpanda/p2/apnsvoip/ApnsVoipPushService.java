...
public class ApnsVoipPushService implements PushService {
  ...
  public ApnsVoipPushService() {
    ...
    try {
      ...
      sslContext.init(
        new KeyManager[] { new ClientCertificateKeyManagerVoip() },
        null,
        null
      );
    ...
    ApnsVoipConfiguration configuration = Configuration
      .getInstance()
      .getApnsVoipConfiguration();
  ...
  public boolean push(
    ...
    final ApnsVoipConfiguration configuration = Configuration
      .getInstance()
      .getApnsVoipConfiguration();
    ...
    try {
      ...
      if (response.isSuccessful()) {
        ...
        final String errorBodyString = errorBody == null
          ? null
          : errorBody.string();
        LOGGER.warn(
